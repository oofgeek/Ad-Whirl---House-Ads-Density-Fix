...
/*
 * 
 * Updated by Ryan Cain
 * Changed to fix issue w/ displaying house banner ads on higher resolution displays
 * Also includes fix for the icon on house text ads
 * 
 */
  ...
  public void displayCustom() {
    ...
    switch (adWhirlLayout.custom.type) {
      case AdWhirlUtil.CUSTOM_TYPE_BANNER:
        ...
        // get the desnity and calculate it
        ...
        // original call and comment
        // This may be incorrect and need to be adjusted for density.
        //bannerImageView.setLayoutParams(new LayoutParams((int) px320, (int) px50));
        
        
        RelativeLayout.LayoutParams bannerViewParams = new RelativeLayout.LayoutParams(
            android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
            android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        bannerViewParams.height = (int)px50;
        bannerViewParams.width = (int)px320;
      ...
      case AdWhirlUtil.CUSTOM_TYPE_ICON:
        ...
        density = AdWhirlUtil.getDensity(activity);
        px320 = AdWhirlUtil.convertToScreenPixels(320, density);
        px50 = AdWhirlUtil.convertToScreenPixels(50, density);
        double px4 = AdWhirlUtil.convertToScreenPixels(4, density);
        double px6 = AdWhirlUtil.convertToScreenPixels(6, density);

        // now takes into account density
